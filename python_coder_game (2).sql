...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2026 at 03:01 PM
...
INSERT INTO `shop_items` (`item_id`, `name`, `description`, `type`, `rarity`, `price`, `preview_data`, `is_available`, `created_at`) VALUES
(1, 'Default Theme', 'ธีมเริ่มต้นของเกม', 'THEME', 'COMMON', 0.00, '{\"css_class\": \"theme-default\"}', 1, '2026-03-04 18:47:52'),
(2, 'Neon Cyberpunk', 'ธีมสีนีออนสไตล์ Cyberpunk', 'THEME', 'RARE', 500.00, '{\"css_class\": \"theme-neon-cyberpunk\"}', 1, '2026-03-04 18:47:52'),
(3, 'Hacker Terminal', 'ธีมสไตล์ Terminal สีเขียว', 'THEME', 'EPIC', 1500.00, '{\"css_class\": \"theme-hacker\"}', 1, '2026-03-04 18:47:52'),
(4, 'Default Cursor', 'เคอร์เซอร์เมาส์ปกติ', 'MOUSE_EFFECT', 'COMMON', 0.00, '{\"effect\": \"none\"}', 1, '2026-03-04 18:47:52'),
(5, 'Sparkle Trail', 'เมาส์มีประกายแวววาว', 'MOUSE_EFFECT', 'RARE', 300.00, '{\"effect\": \"sparkle\", \"color\": \"#FFD700\"}', 1, '2026-03-04 18:47:52'),
(6, 'Fire Trail', 'เมาส์มีเปลวไฟตามหลัง', 'MOUSE_EFFECT', 'EPIC', 800.00, '{\"effect\": \"fire\", \"color\": \"#FF4500\"}', 1, '2026-03-04 18:47:52'),
(7, 'Matrix Rain', 'ตัวอักษรตกลงมาตามเมาส์', 'MOUSE_EFFECT', 'LEGENDARY', 2500.00, '{\"effect\": \"matrix\", \"color\": \"#00FF00\"}', 1, '2026-03-04 18:47:52'),
(8, 'Basic Frame', 'กรอบโปรไฟล์พื้นฐาน', 'PROFILE_FRAME', 'COMMON', 0.00, '{\"border\": \"2px solid #888\"}', 1, '2026-03-04 18:47:52'),
(9, 'Gold Frame', 'กรอบโปรไฟล์สีทอง', 'PROFILE_FRAME', 'RARE', 400.00, '{\"border\": \"3px solid #FFD700\", \"glow\": true}', 1, '2026-03-04 18:47:52'),
(10, 'Diamond Frame', 'กรอบโปรไฟล์เพชร', 'PROFILE_FRAME', 'EPIC', 1200.00, '{\"border\": \"3px solid #00BFFF\", \"glow\": true, \"animation\": \"shimmer\"}', 1, '2026-03-04 18:47:52'),
(11, 'Legendary Frame', 'กรอบโปรไฟล์ตำนาน — เปลี่ยนสีอัตโนมัติ', 'PROFILE_FRAME', 'LEGENDARY', 3000.00, '{\"border\": \"4px solid\", \"glow\": true, \"animation\": \"rainbow-cycle\"}', 1, '2026-03-04 18:47:52');
...
INSERT INTO `users` (`user_id`, `username`, `password_hash`, `email`, `created_at`, `reputation`, `equipped_theme_id`, `equipped_mouse_effect_id`, `equipped_profile_frame_id`, `avatar_url`, `bio`, `role`, `level`, `xp`, `virtual_currency`) VALUES
(1, 'test', '$2b$10$.g6mWLu5/itUWztGvhusv.WsNSmJMVtge7eMCapzPUDulm0cHiqVW', NULL, '2026-02-18 08:55:06', 10, NULL, NULL, NULL, NULL, NULL, 'user', 2, 250, 70),
(8, '123', '$2b$10$ouVGRGz/415AVML0TBnm4elpb8skVyUrU4GZSW9zIFM.QnXcmeUSy', 'abc@mail.com', '2026-03-24 15:38:32', 10, NULL, NULL, NULL, NULL, NULL, 'user', 1, 0, 0);
...
--
ALTER TABLE `simulation_logs`
  MODIFY `log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1722;

--
-- AUTO_INCREMENT for table `simulation_saves`
--
ALTER TABLE `simulation_saves`
  MODIFY `save_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
