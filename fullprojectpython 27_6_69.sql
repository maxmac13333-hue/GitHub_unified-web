...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 27, 2026 at 03:12 AM
...
(1, 9, 1, 'print(\"Hello, Python!\")', 1, 100, NULL, NULL, '2026-06-26 18:48:40'),
(2, 9, 2, 'name = \"PySim\"\nprint(name)', 1, 100, NULL, NULL, '2026-06-25 16:07:04');
...
INSERT INTO `mini_game_dialogues` (`dialogue_id`, `lesson_id`, `exercise_id`, `dialogue_order`, `exercise_order`, `dialogue_text`, `npc_id`, `npc_emotion`, `location_id`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `mini_game_exercises` (`exercise_id`, `lesson_id`, `exercise_order`, `title`, `description`, `starter_code`, `solution_code`, `test_cases_json`, `xp_reward`, `currency_reward`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `mini_game_exercise_submissions` (`submission_id`, `user_id`, `exercise_id`, `submitted_code`, `submitted_at`) VALUES
(1, 9, 1, 'price = float(input(\"ซื้อสินค้าราคา: \"))\r\n\r\n# คำนวณราคารวมภาษี\r\nvat_total = price * 1.07\r\n\r\n# TODO: แสดงผลราคารวมทั้งหมดให้ถูกต้องตามรูปแบบ\r\nprint(\"ราคารวมทั้งหมดคือ:\", vat_total)', '2026-06-27 01:09:28'),
(2, 9, 3, 'print(\"1B_2A\")', '2026-06-26 20:26:35'),
(5, 9, 6, 'print(\"success\")', '2026-06-26 20:26:54'),
(7, 9, 2, 'print(\"1A_2B\")', '2026-06-26 22:46:25'),
(8, 9, 5, 'print(\"success\")', '2026-06-26 18:20:42'),
(11, 9, 4, 'print(\"success\")', '2026-06-26 22:32:34'),
(16, 9, 7, 'print(\"success\")', '2026-06-25 21:08:30');
...
INSERT INTO `mini_game_npcs` (`npc_id`, `npc_key`, `name`, `avatar_asset_url`, `description`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `mini_game_user_exercise_progress` (`progress_id`, `user_id`, `exercise_id`, `xp_reward`, `currency_reward`, `updated_at`) VALUES
(1, 9, 1, 15, 5, '2026-06-27 01:09:28'),
(12, 9, 2, 20, 10, '2026-06-26 22:46:25'),
(13, 9, 4, 30, 15, '2026-06-26 22:32:34');
...
(9, 'max', '$2b$10$TRgCkVKswG8YDrlapEpeGeEHS6qLijnnXzhfZWg0nIjzzQAd60RLC', 'maxmac13333@gmail.com', '2026-04-19 14:32:12', 10, NULL, NULL, NULL, NULL, NULL, 'user', 0, 1005, 402, 0, 0, NULL, NULL);
...
ALTER TABLE `mini_game_dialogues`
  ...
  ADD KEY `fk_mgd_lesson` (`lesson_id`),
  ADD KEY `idx_mini_game_dialogues_exercise_order` (`exercise_id`,`dialogue_order`);
...
ALTER TABLE `mini_game_exercise_submissions`
  ADD PRIMARY KEY (`submission_id`),
  ADD UNIQUE KEY `uq_user_exercise_submission` (`user_id`,`exercise_id`),
  ADD KEY `fk_mini_game_submissions_exercise` (`exercise_id`);
...
ALTER TABLE `mini_game_user_exercise_progress`
  ...
  ADD UNIQUE KEY `uq_user_exercise_progress` (`user_id`,`exercise_id`),
  ADD KEY `fk_mini_game_progress_exercise` (`exercise_id`);
...
--
ALTER TABLE `mini_game_dialogues`
  MODIFY `dialogue_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `mini_game_exercise_submissions`
  MODIFY `submission_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
...
--
ALTER TABLE `mini_game_dialogues`
  ADD CONSTRAINT `fk_mgd_exercise` FOREIGN KEY (`exercise_id`) REFERENCES `mini_game_exercises` (`exercise_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_mgd_lesson` FOREIGN KEY (`lesson_id`) REFERENCES `lessons` (`lesson_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_mgd_location` FOREIGN KEY (`location_id`) REFERENCES `mini_game_locations` (`location_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_mgd_npc` FOREIGN KEY (`npc_id`) REFERENCES `mini_game_npcs` (`npc_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `mini_game_exercises`
  ADD CONSTRAINT `fk_mge_lesson` FOREIGN KEY (`lesson_id`) REFERENCES `lessons` (`lesson_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_mini_game_exercises_main_lessons` FOREIGN KEY (`lesson_id`) REFERENCES `lessons` (`lesson_id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `mini_game_exercise_submissions`
--
ALTER TABLE `mini_game_exercise_submissions`
  ADD CONSTRAINT `fk_mges_exercise` FOREIGN KEY (`exercise_id`) REFERENCES `mini_game_exercises` (`exercise_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_mges_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
